...
public record WorkflowStepsCreatedNotification(WorkflowStepsCreatedEvent DomainEvent) : DomainNotificationEventWrapper<WorkflowStepsCreatedEvent>(DomainEvent);
