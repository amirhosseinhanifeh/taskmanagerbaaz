...
public class DoneTaskHandler : ICommandHandler<DoneTaskCommand, bool>
{
    private readonly ILogger<CreateTaskHandler> _logger;
    private readonly IMapper _mapper;
    private readonly ITaskCatalogDbContext _taskCatalogDbContext;

    public DoneTaskHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (created != null)
        {
            created.ChangeStatus(Domain.SharedKernel.TaskStatus.Done);
            created.AddDomainEvent(new TaskDoneEvent(created));
