...
public class UserSelectionEntityTypeConfiguration : IEntityTypeConfiguration<UserSelection>
{
    public void Configure(EntityTypeBuilder<UserSelection> builder)
    {
        builder.ToTable("UserSelections", TaskCatalogDbContext.DefaultSchema);
